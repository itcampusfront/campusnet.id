        ...
        <div class="card-body">
            <form method="post" action="{{ route('admin.artikel.kontributor.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="kontributor" class="form-control {{ $errors->has('kontributor') ? 'border-danger' : '' }}" value="{{ old('kontributor') }}">
