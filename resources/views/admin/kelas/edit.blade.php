...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-list"></i> Edit Kelas</h1>
      <p>Menu untuk mengedit data kelas</p>
    </div>
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="tile">
        <form id="form" method="post" action="/admin/kelas/update" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="tile-body">
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="nama_kelas" class="form-control {{ $errors->has('nama_kelas') ? 'is-invalid' : '' }}" value="{{ $kelas->nama_kelas }}" placeholder="Masukkan Nama kelas">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div id="editor">{!! html_entity_decode($kelas->deskripsi_kelas) !!}</div> 
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="kategori_kelas" class="form-control {{ $errors->has('kategori_kelas') ? 'is-invalid' : '' }}">
                          ...
                          <option value="{{ $data->id_kategori }}" {{ $kelas->kategori_kelas == $data->id_kategori ? 'selected' : '' }}>{{ $data->nama_kategori }}</option>
                          @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="pengajar_kelas" class="form-control {{ $errors->has('pengajar_kelas') ? 'is-invalid' : '' }}">
                          ...
                          <option value="{{ $data->id_user }}" {{ $kelas->pengajar_kelas == $data->id_user ? 'selected' : '' }}>{{ $data->nama_user }}</option>
                          @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="level_kelas" class="form-control {{ $errors->has('level_kelas') ? 'is-invalid' : '' }}">
                          ...
                          <option value="{{ $data->id_level }}" {{ $kelas->level_kelas == $data->id_level ? 'selected' : '' }}>{{ $data->nama_level }}</option>
                          @endforeach
                        </select>
                    ...
                    <!-- <div class="form-group col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="harga_kelas" class="form-control number-only thousand-format {{ $errors->has('harga_kelas') ? 'is-invalid' : '' }}" value="{{ number_format($kelas->harga_kelas,0,'.','.') }}" placeholder="Masukkan Harga">
                        </div>
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <br>
                      <img id="img-file" src="{{ $kelas->gambar_kelas != '' ? asset('assets/images/kelas/'.$kelas->gambar_kelas) : '' }}" class="mt-2 img-thumbnail {{ $kelas->gambar_kelas != '' ? '' : 'd-none' }}" style="max-height: 150px">
