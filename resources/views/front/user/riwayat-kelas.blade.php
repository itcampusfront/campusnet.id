    ...
    <div class="container mb-5">
        ...
        <section class="row">
            ...
            <div class="col-lg-9 col-md-8 mb-3">
                <div class="card">
                    <div class="card-header">Riwayat Kelas</div>
                    <div class="card-body">
                        <!-- Kelas -->
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6 mb-3">
                                    <div class="card">
                                        ...
                                        <div class="card-footer text-muted text-center">
                                            <small data-toggle="tooltip" title="Diikuti pada {{ date('d/m/Y H:i:s', strtotime($data->mk_at)) }}">Diikuti pada {{ date('d/m/Y', strtotime($data->mk_at)) }}</small>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
