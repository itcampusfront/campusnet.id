            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div class="card border-0 rounded-3 shadow-sm mb-4">
                        <img class="shadow rounded-3" src="{{asset('assets/images/banner/1.1.png')}}">
                        <div class="card-body">
            ...
            <div id="client-carousel" class="owl-carousel owl-theme">
                <div class="item py-3">
                    <div class="card rounded-3 border-0 shadow-sm">
                        <img style="height: 30px; width:30px; background-color: var(--color-1)" class="card-img-top rounded-3" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                        <div class="card-body">
                            <h5 class="m-0">Jon Doe</h5>
                            <p class="m-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante ultricies nisi vel augue quam semper libero.</p>
                        </div>
                    </div>
                </div>
                <div class="item py-3">
                    <div class="card rounded-3 border-0 shadow-sm">
                        <img style="height: 30px; width:30px; background-color: var(--color-2)" class="card-img-top rounded-3" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                        <div class="card-body">
                            <h5 class="m-0">Jon Doe</h5>
                            <p class="m-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante ultricies nisi vel augue quam semper libero.</p>
                        </div>
        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-md-6 mb-3 mb-md-0 text-center text-md-left">
                    ...
                    <h5 class="font-weight-normal">Talk with one of Schoology’s edtech specialists to learn how you can transform the learning experience at your school or district.</h5>
                    <button class="btn btn-theme btn-theme-1 rounded-4">Request A Demo</button>
                </div>
                <div class="col-md-6">
